...
function activerTri() {
    ...
    select.addEventListener("change", () => {
        ...
        let copie = [...dataSeries]; // on clone pour ne pas casser les données
